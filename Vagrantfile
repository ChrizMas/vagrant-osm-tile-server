...
Vagrant.configure(2) do |config|
    ...
    config.vm.provision "shell", inline: "echo $1 | grep -xq \"$1\" /home/vagrant/.ssh/authorized_keys || echo $1 | tee -a /home/vagrant/.ssh/authorized_keys", args: [File.read(File.expand_path(setting['ssh_public_key_path']))]
